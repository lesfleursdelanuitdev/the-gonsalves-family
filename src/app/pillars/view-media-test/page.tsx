...
import { ViewMediaSection } from "@/components/homepage/Pillars/sections/ViewMediaSection";
import { PILLARS_SECTION_SURFACE } from "@/components/homepage/Pillars/pillars-section-surface";
import { PILLARS } from "@/data/pillars";

/**
 * Isolated preview of the View Media pillar (camera art + edge card).
 */
export default function ViewMediaSectionTestPage() {
  ...
  return (
    <div className="min-h-screen bg-bg">
      <main className="min-h-screen py-8">
        ...
        <p className="px-6 pb-6 text-center text-xs text-muted">ViewMediaSection — single column</p>
        <section
          ref={sectionRef}
