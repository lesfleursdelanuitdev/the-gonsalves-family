...
import { ReadHistoriesSection } from "@/components/homepage/Pillars/sections/ReadHistoriesSection";
import { PILLARS_SECTION_SURFACE } from "@/components/homepage/Pillars/pillars-section-surface";
import { PILLARS } from "@/data/pillars";

/**
 * Isolated preview of the Read Histories pillar (Sydney photo + caption).
 */
export default function ReadHistoriesSectionTestPage() {
  ...
  return (
    <div className="min-h-screen bg-bg">
      <main className="min-h-screen py-8">
        ...
        <p className="px-6 pb-6 text-center text-xs text-muted">ReadHistoriesSection — single column</p>
        <section
          ref={sectionRef}
